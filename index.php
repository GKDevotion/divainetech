                ...
                <div class="col-lg-8">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="hero-footer">
                            <a href="contact-us.php" class="btn-default wow fadeInUp" data-wow-delay="0.75s">free consultation</a>
                        </div>
                        <!-- Hero Footer End -->
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-content">
                        ...
                        <a href="about.php" class="btn-default wow fadeInUp" data-wow-delay="1.25s">free consultation</a>
                    </div>
            ...
            <div class="row section-row align-items-center">
                ...
                <div class="col-lg-5 col-md-5">
                    ...
                    <div class="section-btn">
                        <a href="javascript:void();" class="btn-default wow fadeInUp" data-wow-delay="0.25s">view all services</a>
                    </div>
                    <!-- Section Btn End -->
                </div>
            </div>
