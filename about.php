    ...
    <?php
        $seo = [
            'title' => 'About Divaine Tech | Leading IT Services & Technology Solutions Provider',
            'description' => 'Learn about Divaine Tech, a technology solutions company delivering web development, software development, digital transformation, and innovative IT services to help businesses grow.',
            'keywords' => 'About Divaine Tech, IT company, technology solutions, web development company, software development services, digital transformation',
            'author' => 'Divaine Tech'
        ];
